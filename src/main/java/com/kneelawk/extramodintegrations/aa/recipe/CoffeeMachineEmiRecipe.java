package com.kneelawk.extramodintegrations.aa.recipe;
...
public class CoffeeMachineEmiRecipe extends BasicEmiRecipe {
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        if (extraText != null && !extraText.isEmpty()) {
            widgets.addText(Component.translatable("jei.actuallyadditions.coffee.special").append(":"), 2, 4, 0x404040, false);
            widgets.addText(Component.translatable(extraText), 2, 16, 0x404040, false);
        }

        if (maxAmplifier > 0) {
            widgets.addText(Component.translatable("jei.actuallyadditions.coffee.maxAmount").append(": " + maxAmplifier), 2, 28, 0x404040, false);
        }
